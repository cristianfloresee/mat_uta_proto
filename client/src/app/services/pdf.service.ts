...
export class PdfService {
   ...
   generarNuevos(data, selected, canvas_url) {
      ...
      /*
      // TOTAL
      console.log('T SELECCIONADOS :', arrayTotal.SELECCIONADOS);
      console.log('T LISTA ESPERA :', arrayTotal.LISTA_ESPERA);
      console.log('T REPOSTULACION :', arrayTotal.REPOSTULACION);
      console.log('T INGRESO ESPECIAL :', arrayTotal.INGRESO_ESPECIAL);
      console.log('T VACANTES :', arrayTotal.VACANTES);
      console.log('T MATRICULADOS :', arrayTotal.MATRICULADOS);
      console.log('T % :', arrayTotal.MAT_PORCENTAJE);
      console.log('T OTROS INGRESOS :', arrayTotal.OTROS_INGRESOS);
      console.log('T MATRICULA TOTAL :', arrayTotal.MAT_TOTAL);*/

      /*
      
            t_seleccionados = arrayTotal.SELECCIONADOS;
            t_lista_espera = arrayTotal.LISTA_ESPERA;
            t_repostulacion = arrayTotal.REPOSTULACION;
            t_ingreso_especial = arrayTotal.INGRESO_ESPECIAL;
            t_vacantes = arrayTotal.VACANTES;
            t_matriculados = arrayTotal.MATRICULADOS;
      
            const t_p = Number(arrayTotal.MAT_PORCENTAJE);
            t_porcentaje = t_p.toFixed(0) + '%';
      
            // t_porcentaje = arrayTotal.MAT_PORCENTAJE;
            t_otros_ingresos = arrayTotal.OTROS_INGRESOS;
            t_matricula_total = arrayTotal.MAT_TOTAL;
            ...
            var anio_th: any = this.obj_selected['ANIO'];
            var sede_th: any = this.obj_selected['SEDE'];
            var carrera_th: any = this.obj_selected['TIPO_CARRERA'];
            var canvas_th: any = this.getCanvasURL();
